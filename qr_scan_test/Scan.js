                ...
                <Fragment>
                    <View style={styles.header}>
                        <TouchableOpacity onPress={() => BackHandler.exitApp()}>
                            <Image source={require('../src/Images/sltda-logo.png')} style={{ height: 36, width: 36 }}></Image>
                        </TouchableOpacity>
                    ...
                    {!scan && !ScanResult &&
                        <View style={styles.cardView} >
                            ...
                            <Image source={require('../src/Images/sltda-logo.png')} style={{ margin: 20 }}></Image>
                    ...
                    {scan &&
                        <QRCodeScanner
                            ...
                            bottomContent={
                                <View>
                                    <ImageBackground source={require('../src/Images/sltda-logo.png')} style={styles.bottomContent}>
                                        <TouchableOpacity style={styles.buttonScan2}
                                            onPress={() => this.scanner.reactivate()}
                                            onLongPress={() => this.setState({ scan: false })}>
                                            <Image source={require('../src/Images/sltda-logo.png')}></Image>
                                        </TouchableOpacity>
                                    </ImageBackground>
                                </View>
                            }
